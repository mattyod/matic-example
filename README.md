...
You should now have a new folder called 'web' within the sample project. Within this should be a file called example.html, open this with a browser and view the generated documentation.
...
[An example of the output](http://mattyod.github.com/matic-example/).
